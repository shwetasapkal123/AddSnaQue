...
namespace SneakLadder
{
     class SnakeLadder
    {
        ...
        public int PlayGame()               //Method or function create
        {
            while(player<100)
            {
        ...
        {
            SnakeLadder gamePlay1 = new SnakeLadder();      //object created
            int player1Trials=gamePlay1.PlayGame();         //calling function

            SnakeLadder gamePlay2 = new SnakeLadder();      //object created
